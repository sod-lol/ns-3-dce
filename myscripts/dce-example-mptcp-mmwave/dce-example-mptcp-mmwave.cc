...
static ns3::GlobalValue g_congestionControl("congestionControl",
    "CC algorithm",
    ns3::StringValue("olia"), ns3::MakeStringChecker());
...
int main (int argc, char *argv[])
{
  ...
  lteHelper_2->SetEnbDeviceAttribute ("DlEarfcn", UintegerValue (600));
  lteHelper_2->SetEnbDeviceAttribute ("UlEarfcn", UintegerValue (18600));
  //lteHelper_2->Initialize();
  ...
  pointToPoint.EnablePcapAll ("mptcp-lte-mmwave", false);

	lteHelper_2->EnablePhyTraces ();
	lteHelper_2->EnableMacTraces ();
